...
from netsquid.components.instructions import INSTR_X,INSTR_Z,INSTR_H,INSTR_CNOT,INSTR_MEASURE,INSTR_TOFFOLI
...
from ATw_center import AT_Wstate_center
from ATw_side import AT_Wstate_side

import sys
scriptpath = "lib/"
sys.path.append(scriptpath)
from functions import INSTR_NToffoli,AssignStatesBydm
